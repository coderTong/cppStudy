...
void test02()
{
    ...
    v.push_back( Maker("aaa3", 31) );
    v.push_back( Maker("aaa4", 22) );
    v.push_back( Maker("aaa5", 10) );
    ...
    it = find_if( v.begin(), v.end(), bind2nd( MyFind(), Maker("aaa4", 22)  )  );
...
void test05()
{
    ...
    // 大于2的元素 有多少个
    n = count_if( v.begin(), v.end(), [](int val)->bool{
